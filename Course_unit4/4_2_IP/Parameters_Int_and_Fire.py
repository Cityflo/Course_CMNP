...
t_0=0 # initial time
t_max=100000 # total simulationtime in ms
...
firing_rate_e=3 # firing rate of the poisson excitatory synapse in Hz (per second!!!!)
w_e=0.35 # strength of all the excitatory weights
...
w_i=1.0 # strength of all the inhibitory weights
numb_inh_syn=5 # number of inhibitory synapses
...
file.write("etha_IP= %(etha_IP)f\n" % {"etha_IP":etha_IP})
file.write("R_target= %(R_target)f\n" % {"R_target":R_target})
