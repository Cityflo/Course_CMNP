...
t_0=0 # initial time
t_max=50000#100000 # total simulationtime in ms
...
w_e=0.1 # strength of all the excitatory weights
numb_exc_syn=50 # number of excitatory synapses
...
numb_inh_syn=30 # number of inhibitory synapses
...
file.write("W_tot= %(W_tot)f\n" % {"W_tot":W_tot})
file.write("etha_SN= %(etha_SN)f\n" % {"etha_SN":etha_SN})
