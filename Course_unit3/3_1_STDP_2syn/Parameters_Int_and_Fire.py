...
t_0=0 # initial time
t_max=15000 # total simulation time in ms
...
firing_rate_e=5  # firing rate of the poisson excitatory synapse in Hz (per second!!!!)
w_e=1 # strength of all the excitatory weights
...
w_i=0 # strength of all the inhibitory weights
