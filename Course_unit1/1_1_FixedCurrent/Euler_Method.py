...
################
# Description:
# Class which performs the Euler integration. Call the function euler_integration 
# and pass it the function f which is dy/dt=f(y,t), the initial value y_0 and 
