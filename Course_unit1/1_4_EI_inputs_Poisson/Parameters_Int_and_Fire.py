...
t_0=0 # initial time
t_max=50000#10000 # total simulationtime in ms
...
w_e=0.56 # # strength of all the excitatory weights
numb_exc_syn=10#100 # number of excitatory synapses
...
firing_rate_i=10#10 # firing rate of the poisson inhibitory synapse in Hz (per second!!!!)
w_i=0.5 # strength of all the inhibitory weights
...
######################################################
# create a text file with date & time of simulation
